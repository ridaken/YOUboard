...
import com.youboard.keyboard.latin.common.default
...
import com.youboard.keyboard.settings.dialogs.ColorPickerDialog
...
//                supportingText = { if (!nameValid) Text(stringResource(R.string.name_invalid)) } // todo: this is cutting off bottom half of the actual text...
        ...
        menu = listOf(
            ...
            stringResource(R.string.copy_to_clipboard) to {
                ...
                cm.setPrimaryClip(ClipData.newPlainText("YOUBoard theme", getColorString(prefs, newThemeName.text)))
            },
        ),
