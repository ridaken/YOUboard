...
import com.youboard.keyboard.latin.common.ConstantsKt;
...
import com.youboard.keyboard.latin.common.UnicodeSurrogate;
...
import com.youboard.keyboard.latin.utils.DebugLogUtils;
import com.youboard.keyboard.latin.utils.NgramContextUtils;
...
public final class RichInputConnection implements PrivateCommandPerformer {
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.youboard.keyboard.latin.common.Constants.UnicodeSurrogate
    ...
    @Nullable private CharSequence getTextBeforeCursorAndDetectLaggyConnection(
        ...
        if ((mCommittedTextBeforeComposingText.length() > 0 || mComposingText.length() > 0)
            ...
            //     todo: understand where this inconsistent state comes from, is it really the other app's fault, or is it YOUBoard?
