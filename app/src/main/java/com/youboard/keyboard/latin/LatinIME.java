...
import com.youboard.keyboard.compat.EditorInfoCompatUtils;
import com.youboard.keyboard.compat.ImeCompat;
import com.youboard.keyboard.event.HapticEvent;
import com.youboard.keyboard.keyboard.KeyboardActionListener;
import com.youboard.keyboard.keyboard.KeyboardActionListenerImpl;
import com.youboard.keyboard.keyboard.KeyboardMode;
...
import com.youboard.keyboard.latin.common.InsetsOutlineProvider;
import com.youboard.keyboard.dictionarypack.DictionaryPackConstants;
...
import com.youboard.keyboard.latin.common.ViewOutlineProviderUtilsKt;
...
import com.youboard.keyboard.latin.utils.InputMethodPickerKt;
import com.youboard.keyboard.latin.utils.JniUtils;
import com.youboard.keyboard.latin.utils.KtxKt;
import com.youboard.keyboard.latin.utils.LeakGuardHandlerWrapper;
...
import com.youboard.keyboard.latin.utils.StatsUtils;
import com.youboard.keyboard.latin.utils.StatsUtilsManager;
import com.youboard.keyboard.latin.utils.SubtypeLocaleUtils;
import com.youboard.keyboard.latin.utils.SubtypeSettings;
import com.youboard.keyboard.latin.utils.SubtypeState;
...
public class LatinIME extends InputMethodService implements
    ...
    public void onComputeInsets(final InputMethodService.Insets outInsets) {
        ...
        if (isImeSuppressedByHardwareKeyboard() && !visibleKeyboardView.isShown()) {
            ...
            // way from OpenBoard to YOUBoard (GH-702, GH-1455), but not setting anything seems to work
    ...
    public void launchEmojiSearch() {
        ...
        startActivity(new Intent().setClass(this, EmojiSearchActivity.class)
                          .putExtra(EmojiSearchActivity.SOURCE_INCOGNITO, mSettings.getCurrent().mIncognitoModeEnabled)
