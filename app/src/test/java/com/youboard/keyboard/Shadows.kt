...
import com.youboard.keyboard.latin.DictionaryFacilitatorImpl
...
class ShadowInputMethodManager2 : ShadowInputMethodManager() {
    ...
    override fun getInputMethodList() = listOf(
        if (BuildConfig.BUILD_TYPE == "debug" || BuildConfig.BUILD_TYPE == "debugNoMinify")
            InputMethodInfo("com.youboard.keyboard.debug", "LatinIME", "YOUBoard debug", null)
        else InputMethodInfo("com.youboard.keyboard", "LatinIME", "YOUBoard", null),
    )
    @Implementation
